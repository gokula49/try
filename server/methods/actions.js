...
const client = new OAuth2Client("420079793002-9iiugddoa38lqjrktl2qmrvtikkfbml9.apps.googleusercontent.com");
...
var functions = {
  ...
  LoginUserGoogle: async (req, res) => {
    ...
    await client
      .verifyIdToken({
        idToken: tokenid,
        audience:"420079793002-9iiugddoa38lqjrktl2qmrvtikkfbml9.apps.googleusercontent.com",
      })
      .then((response) => {
