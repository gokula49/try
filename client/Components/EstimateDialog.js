...
export default function EstimateDialog({id,handleclose}){
    const[post,setpost]=useState({
      user_id:id.user_id,
      customer_name:id.customer_name,
      estimate_date:id.estimate_date,
      expiry_date:id.expiry_date,
      reference:id.reference,
      total:id.total,
      items_name:id.items[0].name,
      items_quantity:id.items[0].quantity,
      items_amount:id.items[0].amount,
